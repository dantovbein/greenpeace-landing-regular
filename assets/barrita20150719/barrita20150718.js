...
////////// Comienzo opciones de personalización:
	...
	var donacionesHastaAhora = 'PERSONAS YA SON GUARDAPARQUES';
	var faltan = 'FALTAN';
...
////////// Fin opciones de personalización	
	...
	function inicializar(firmas){			
		...
		document.getElementById("sumate").innerHTML = sumate;
		document.getElementById("meta").innerHTML = nuestraMeta + ": " + TS(meta) + ' ' + donaciones;
	}
	...
	function displayHTML(){				
		...
		barrita_html += '		<div id="sumate" class="sumate" style="color:'+ colorSumate +' !important"></div>';
		barrita_html += '		<div id="meta" class="meta" style="color:'+ colorMeta +' !important"></div>';
		barrita_html += '	</div>';
		barrita_html += '	<div class="clear"></div>';
		barrita_html += '	<div class="barrita">';
		barrita_html += '		<div class="ruler"></div>';
		barrita_html += '		<div class="div_progress"><img class="progress" id="progress" src="barrita/images/progress_green.png" /></div>';
...
//		barrita_html += '		<div id="deCounterNumber" class="deCounterNumber" style="color:'+ colorDonacionesParaLlegar +' !important">&nbsp;</div>';
	...
	function displayNumber(){
		if(aux2 < counterNumber){
			...
			document.getElementById("counterNumber").innerHTML = '<b style="font-size:14px">' + TS(Math.round(aux2)) + '</b> ' + donacionesHastaAhora;
